...
<div class="box-content">
	...
	<table>
		...
		<tr>
			...
			<td><img style="border: 1px solid #ccc;width: 50px; height: 50px;" src="<?php echo INCLUDE_PATH_PAINEL?>uploads/<?php echo $value["capa"];?>"></td>
			<td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-noticia?id=<?php echo $value["id"];?>"><i style="" class="fas fa-pencil-alt"></i> Editar</a></td>
			...
			<td><a class="btn order" href="<?php INCLUDE_PATH_PAINEL ?>gerenciar-noticias?order=up&id=<?php echo $value["id"]?>"><i class="fa fa-angle-up"></a></td>
			<td><a class="btn order" href="<?php INCLUDE_PATH_PAINEL ?>gerenciar-noticias?order=down&id=<?php echo $value["id"]?>"><i class="fa fa-angle-down"></a></td>
		</tr>
