<?php 
	...
	class Painel
	{
		...
		/*
			...
			Metodo espeficico para selecionar apenas um registro.
		...
		*/
		...
		public static function orderItem($tabela,$orderType,$idItem){
			...
			if($orderType == "up"){
				...
				$itemBefore = Mysql::conectar()->prepare("SELECT * FROM `$tabela` WHERE order_id < $order_id  ORDER BY id DESC LIMIT 1");
				$itemBefore->execute();
